...
import org.neo4j.driver.internal.bolt.basicimpl.impl.messaging.common.CommonMessageReader;
...
class MessageFormatV3Test {
    ...
    void shouldCreateCorrectWriter() {
        var writer = messageFormat.newWriter(mock(PackOutput.class), mock(ValueFactory.class));

        assertInstanceOf(MessageWriterV3.class, writer);
    }

    @Test
    void shouldCreateCorrectReader() {
        var reader = messageFormat.newReader(mock(PackInput.class), mock(ValueFactory.class));
