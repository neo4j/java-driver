...
class ChannelErrorHandlerTest {
    ...
    void shouldHandleChannelInactive() {
        ...
        assertInstanceOf(BoltServiceUnavailableException.class, error);
        assertTrue(error.getMessage().startsWith("Connection to the database terminated"));
    ...
    void shouldHandleChannelInactiveAfterExceptionCaught() {
        ...
        assertInstanceOf(BoltServiceUnavailableException.class, error2);
        assertTrue(error2.getMessage().startsWith("Connection to the database terminated"));
        //        assertFalse(channel.isOpen());
    }
    ...
    void shouldHandleChannelInactiveWhenTerminationReasonSet() {
        ...
        assertInstanceOf(BoltServiceUnavailableException.class, error);
        assertTrue(error.getMessage().startsWith("Connection to the database terminated"));
        assertTrue(error.getMessage().contains(terminationReason));
        //        assertFalse(channel.isOpen());
    }
