 ...
 */
package org.neo4j.driver.internal.bolt.basicimpl.impl.messaging.v56;
...
import static org.neo4j.driver.internal.bolt.basicimpl.impl.messaging.request.DiscardAllMessage.DISCARD_ALL;
import static org.neo4j.driver.internal.bolt.basicimpl.impl.messaging.request.GoodbyeMessage.GOODBYE;
...
import org.neo4j.driver.internal.bolt.basicimpl.impl.util.messaging.AbstractMessageWriterTestBase;
...
public class MessageWriterV56Test extends AbstractMessageWriterTestBase {
    ...
    protected MessageFormat.Writer newWriter(PackOutput output) {
        return BoltProtocolV56.INSTANCE.createMessageFormat().newWriter(output, valueFactory);
    }
