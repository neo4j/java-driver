...
class BoltServerAddressTest {
    ...
    void defaultPortShouldBe7687() {
        assertEquals(7687, DEFAULT_PORT);
    }

    @Test
    void portShouldUseDefaultIfNotSupplied() {
        assertEquals(BoltServerAddress.DEFAULT_PORT, new BoltServerAddress("localhost").port());
    }
    ...
    void shouldIncludeHostAndPortInToString() {
        ...
        assertEquals("localhost:8081", address.toString());
    }
}
